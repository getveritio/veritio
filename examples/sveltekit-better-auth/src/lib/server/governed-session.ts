 ...
 * enforces this and the Cloud re-redacts again at ingest. This module lives under
 * `$lib/server` (SvelteKit never bundles it to the client).
 */
...
/** Reuses one session feed (newest first) across Vite/HMR server reloads. */
